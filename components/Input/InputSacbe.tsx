      ...
      {variant === 'cross' ? (
        <div className='relative w-full'>
          <input
            ...
            className={cn(
              `text-2xl appearance-none no-spinners autofill:fill-none  text-sacbeBlue placeholder:text-sacbeBlue pl-10 bg-inherit border-[2px] border-sacbeBlue w-full font-Tungsten h-8 xl:h-12 outline-none`,
